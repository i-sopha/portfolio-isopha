  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/i-sopha" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <div className="row aligner" style={{height: '100%'}}>
          <div className="col-md-12">
            <div>
              <span className="iconify header-icon" data-icon="openmoji:desktop-computer" data-inline="false"></span>
              <br/>
              <h1 className="mb-0">
                {name}
              </h1>
